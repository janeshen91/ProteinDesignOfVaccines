...
'contigmap.length=60-700'  >/vaxart-batch-output/202409_RFDiffusion/VX22/RFDiffusion/prompt2.out &

##calculate radius of gyration
python3 /vaxart-batch-output/202409_RFDiffusion/scripts/radiusOfGyration_folder.py VX22/RFDiffusion/prompt2
python3 /vaxart-batch-output/202409_RFDiffusion/scripts/radiusOfGyration_folder.py VX22/RFDiffusion/prompt2
###change the jsonl file to do proteinMPNN on the fixed positions
python3 /vaxart-batch-output/202409_RFDiffusion/scripts/processTRBinAFolder.py ./VX22/RFDiffusion/prompt1 ./VX22/RFDiffusion/prompt1TRBout.txt
###measure the distance between the proteinMPNN generated structures and the original, use that as filter??

python ./scripts/calculateDistanceBetweenMoftifs.py ./VX22/RFDiffusion/prompt2_proteinMotifPositions.txt ./VX22/RFDiffusion/prompt2MotifDistance.txt
##summarize lengths of the proteins generated

python ./scripts/calculateDistanceBetweenMoftifs.py ./VX22/RFDiffusion/prompt2_proteinMotifPositions.txt 

sed -i -e 's/":/.pdb":/g' ./VX22/RFDiffusion/prompt2TRBout.txt
python ./scripts/calculateDistanceBetweenMoftifs.py ./VX22/RFDiffusion/prompt2TRBout.txt ./VX22/RFDiffusion/prompt2Distances.txt
...
docker run --gpus all \
-v /vaxart-batch-output/202409_RFDiffusion/VX22//:/output \
...
--sampling_temp "0.1" \
--seed 37 \
--batch_size 1 >/vaxart-batch-output/202409_RFDiffusion/VX22//ProteinMPNN/proteinMPNNPrompt1AllHigher.txt &
...
--sampling_temp "0.1" \
--seed 37 \
--batch_size 1 >/vaxart-batch-output/202409_RFDiffusion/VX22/ProteinMPNN/proteinMPNNPrompt2All.txt &


###
 nohup colabfold_batch --model-type alphafold2 \
 /vaxart-batch-output/202409_RFDiffusion/VX22/ProteinMPNN/prompt1All/seqs/RFDiffusion_prompt1_1.fa \
 /vaxart-batch-output/202409_RFDiffusion/VX22/ProteinMPNN/Prompt1AllFolding/RFDiffusion_prompt1_1_folding \
  >/vaxart-batch-output/202409_RFDiffusion/VX22//ProteinMPNN/Prompt1AllFolding.txt &



 nohup colabfold_batch --model-type alphafold2 \
 /vaxart-batch-output/202409_RFDiffusion/VX22/ProteinMPNN/prompt1All/seqs/RFDiffusion_prompt1_199.fa \
 /vaxart-batch-output/202409_RFDiffusion/VX22/ProteinMPNN/Prompt1AllFolding/RFDiffusion_prompt1_199_folding \
  >/vaxart-batch-output/202409_RFDiffusion/VX22//ProteinMPNN/Prompt1AllFolding199.txt &
...
--sampling_temp "0.2" \
--seed 37 \
--batch_size 10 >/vaxart-batch-output/202409_RFDiffusion/VX22//ProteinMPNN/proteinMPNNPrompt1All2.txt &
...
python ./scripts/outputDistanceFromPDBandMofit2.py ./VX22/RFDiffusion/prompt2_proteinMotifPositions.csv ./VX22/RFDiffusion/prompt2_proteinMotifPositions_output2.csv
 
 
##use the above script on the original pdb
python ./scripts/outputDistanceFromPDBandMofit2.py ./VX22/RFDiffusion/'prompt2_proteinMotifPositions=3.csv' ./VX22/originalVX22AndMotifPositionOutput.csv ##i think this is prompt1
 
python ./scripts/outputDistanceFromPDBandMofit2.py ./VX22//originalVX22AndMotifPosition2.csv ./VX22/originalVX22AndMotifPositionOutput2.csv
##find the difference between these 2 matrices
#(I guess i could actually use R for it but we'll just continue chatgpt-ing)
python ./scripts/distanceBetween2pdb.py ./VX22/RFDiffusion/prompt2_proteinMotifPositions_output2.csv ./VX22/originalVX22AndMotifPositionOutput2.csv ./VX22/output_differences2.csv
##add 2 for the ord2 (ie supposedly eucliean distance)


##doing the same for prompt1
python ./scripts/outputDistanceFromPDBandMofit2.py ./VX22/RFDiffusion/prompt1_motifPositions ./VX22/RFDiffusion/prompt1_proteinMotifPositions_output.csv
#python ./scripts/outputDistanceFromPDBandMofit2.py ./VX22//originalVX22AndMotifPosition2.csv ./VX22/originalVX22AndMotifPositionOutput2.csv
python ./scripts/distanceBetween2pdb.py ./VX22/RFDiffusion/prompt1_proteinMotifPositions_output.csv ./VX22/originalVX22AndMotifPositionOutput.csv ./VX22/q.csv
...
'contigmap.length=60-700'  >/vaxart-batch-output/202409_RFDiffusion/VX22/RFDiffusion/prompt3.out &
...
#RFDiffusion_prompt1_169
 ...
 nohup colabfold_batch --model-type alphafold2 \
 /vaxart-batch-output/202409_RFDiffusion/VX22/ProteinMPNN/prompt1All/seqs/RFDiffusion_prompt1_169.fa \
 /vaxart-batch-output/202409_RFDiffusion/VX22/ProteinMPNN/Prompt1AllFolding/RFDiffusion_prompt1_169_folding \
  >/vaxart-batch-output/202409_RFDiffusion/VX22//ProteinMPNN/Prompt1AllFolding169.txt &
...
python3 ./scripts/processTRBinAFolder.py ./VX22/RFDiffusion/prompt3 ./VX22/RFDiffusion/prompt3TRBout.txt
...
--sampling_temp "0.1" \
--seed 37 \
--batch_size 1 >/vaxart-batch-output/202409_RFDiffusion/VX22/ProteinMPNN/proteinMPNNPrompt3All.txt &


##checking the score for all prompt1
##alphafold
nohup colabfold_batch --model-type alphafold2 \
/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt1FastaToRunAFon.fa \
/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt1FastaToRunAFon \
>/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt1FastaToRunAFon.txt &
  
  
##AF3 on the G6E server
docker run -d -v /vaxart-batch-output/202409_RFDiffusion/AF3selfRun:/af_input \
-v /vaxart-batch-output/202409_RFDiffusion/AF3selfRun/models:/root/models \
...
#go through the xml files in /vaxart-batch-output/database
nohup colabfold_batch --model-type alphafold2 \
/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt2FastaToRunAFon.fa \
/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt2/prompt2FastaToRunAFon \
>/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt2FastaToRunAFon.txt &

##prompt3
nohup colabfold_batch --model-type alphafold2 \
/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt3FastaToRunAFon.fa \
/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt3/prompt3FastaToRunAFon \
>/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt3FastaToRunAFon.txt &
  


docker run -v /vaxart-batch-output/database/:/database/ \
...
python /vaxart-batch-output/202409_RFDiffusion/scripts/parseXML4.py \
/vaxart-batch-output/database/GenbankIDAndSequenceAll2.fa \
/vaxart-batch-output/database/GenbankIDAndSequenceAllDB.fa

nohup docker run -v /vaxart-batch-output/database/:/database/ \
620901718958.dkr.ecr.us-east-2.amazonaws.com/blast makeblastdb \
-dbtype 'prot' -in /database/GenbankIDAndSequenceAllDB.fa &
###blastp against the current database

docker run -v /vaxart-batch-output/database/:/database/ \
-v /vaxart-batch-output/202409_RFDiffusion/VX22/AF/:/input/ \
...
>/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt2AgainstIEDB.txt
...
--output_dir=/af_input/fold_prompt1Test
 ...
 nohup colabfold_batch --model-type alphafold2 \
 /vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt1Higher/prompt1HigherFastaToRunAFon.fa \
 /vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt1Higher \
  >/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt1HigherFastaToRunAFon.txt &
...
>/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt1HigherAgainstIEDB.txt

nohup docker run -v /vaxart-batch-output/202409_RFDiffusion/VX22/AF3:/af_input \
-v /vaxart-batch-output/202409_RFDiffusion/AF3selfRun/models:/root/models \
-v /home/ec2-user/databases:/root/public_databases --gpus all alphafold3 python run_alphafold.py \
...
'contigmap.contigs=[1-100/A235-236/1-100/A307-309/1-100/A478-483/1-100/A510-511/1-100]' \
'contigmap.length=60-700'  >/vaxart-batch-output/202409_RFDiffusion/VX22/RFDiffusion/prompt1ii.out &
...
inference.num_designs=400 \
'contigmap.contigs=[1-100/A235-236/1-100/A307-309/1-100/A478-484/1-100/A509-513/1-100]' \
'contigmap.length=60-700'  >/vaxart-batch-output/202409_RFDiffusion/VX22/RFDiffusion/prompt2ii.out &

python3 /vaxart-batch-output/202409_RFDiffusion/scripts/processTRBinAFolder.py \
./VX22/RFDiffusion/RFDiffusion_prompt1ii ./VX22/RFDiffusion/prompt1iiTRBout.txt


python3 /vaxart-batch-output/202409_RFDiffusion/scripts/processTRBinAFolder.py \
./VX22/RFDiffusion/RFDiffusion_prompt2ii ./VX22/RFDiffusion/prompt2iiTRBout.txt
...
--sampling_temp "0.1" \
--seed 37 \
--batch_size 1 >/vaxart-batch-output/202409_RFDiffusion/VX22//ProteinMPNN/proteinMPNNPrompt1ii.txt &
...
--sampling_temp "0.1" \
--seed 37 \
--batch_size 1 >/vaxart-batch-output/202409_RFDiffusion/VX22//ProteinMPNN/proteinMPNNPrompt2ii.txt &
...
####
nohup colabfold_batch --model-type alphafold2 \
/vaxart-batch-output/202409_RFDiffusion/VX22/ProteinMPNN/prompt1iiToRunAFon.fa \
/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt1iiFastaToRunAFon \
>/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt1iiFastaToRunAFon.txt &

nohup colabfold_batch --model-type alphafold2 \
/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt2iiToRunAFon.fa \
/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt2iiFastaToRunAFon \
>/vaxart-batch-output/202409_RFDiffusion/VX22/AF/prompt2iiFastaToRunAFon.txt &
...
###running blastp
docker run -v /vaxart-batch-output/database/:/database/ \
-v /vaxart-batch-output/202409_RFDiffusion/VX22/best6/:/input/ \
620901718958.dkr.ecr.us-east-2.amazonaws.com/blast blastp \
-db /database/GenbankIDAndSequenceAllDB.fa -outfmt 6 -num_threads 6 \
-query /input/sixToTest.fasta -evalue 0.01 \
>/vaxart-batch-output/202409_RFDiffusion/VX22/best6/best6AgainstIEDB.txt